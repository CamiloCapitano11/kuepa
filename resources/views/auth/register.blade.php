...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">{{ __('Formulario de Registro para Estudiantes') }}</div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <select class="form-control" id="program_interest" name = "program_interest">
                                    <option value = "">Seleccione un programa por favor</option>
                                    <option value = "NA">No Aplicar</option>
